...
/**
 * inorder_successor - This Returns the minimum value of a binary search tree.
...
/**
 * bst_delete - This function deletes a node from a binary search tree.
...
/**
 * bst_remove_recursive - This removes a node from a binary search tree
 * recursively.
 ...
 *
 * Description: If the node to be deleted has two children, it must be
 *              replaced with its first in-order successor.
 */
bst_t *bst_remove(bst_t *root, int value)
{
