...
/**
 * is_avl_helper - This function checks if a binary tree is a valid AVL tree.
 * @tree: A pointer to the root node of the tree to check.
 * @lo: Value of the smallest node visited this far.
 * @hi: Value of the largest node visited this far.
 *
 * Return: returns 1 if the tree is a valid AVL tree, otherwise, 0.
 */
int is_avl_helper(const binary_tree_t *tree, int lo, int hi)
{
