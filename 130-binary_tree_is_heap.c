...
/**
 * tree_is_complete - This function checks if tree is complete
 *
...
/**
 * binary_tree_is_complete - This function calls to tree_is_complete function
 *
 * @tree: Pointer to the tree root
 * Return: 1 if tree is complete, 0 otherwise
 */
 ...
 * Return: 1 if parent has a greater value, otherwise 0
 */
